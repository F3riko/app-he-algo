// src/constants/hebrewLetters.ts
...
export const LetterClassifications = {
  ...
  // Letters that can receive dagesh (בגדכפת)
  BEGADKEFAT: [
    HebrewAlphabet.BET,
...
export const VerbProperties = {
  ...
  // Numbers (renamed to avoid conflicts with built-in Number type)
  GRAMMATICAL_NUMBERS: {
...
export type GrammaticalNumber =
  (typeof VerbProperties.GRAMMATICAL_NUMBERS)[keyof typeof VerbProperties.GRAMMATICAL_NUMBERS];
export type Gender =
